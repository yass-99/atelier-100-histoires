...
/**
 * Wordmark « Atelier aux 100 histoires » — empilé éditorial.
 * Sur-titre « ATELIER AUX » discret, puis ligne forte « 100 histoires »
...
export function LogoLink({
  ...
  return (
    <Link href="/" className="min-w-0" aria-label="Atelier aux 100 histoires — accueil">
